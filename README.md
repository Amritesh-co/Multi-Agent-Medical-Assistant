...
> 1. **Document Processing**: Docling-based parsing for extraction of text, tables, and images to be embedded.
...
For a detailed demo video, check out the demo video in the assets folder. 📽️
